<x-app-layout>
    ...
    <div class="w-full">
        ...
        @if (session()->has('error'))
            <div id="alert" class="place-content-center bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded relative flex transition-opacity duration-500 ease-in-out" role="alert">
                <div>
                                        ...
                                        <div class="py-3 px-4 w-1/2 text-end">
                                            <div class="relative max-w">
                                                <a href="{{ route('admin.permissions.create') }}" type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" wire:click="createUser">
                                                    ...
                                                    <span class="ms-2">Adicionar Permissão</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
